...
function Giphy() {
  ...
  return (
    <div className="mt-10 px-3">
      <div className="mb-5 w-full flex flex-wrap justify-between">
        <img src="https://developers.giphy.com/branch/master/static/header-logo-0fec0225d189bc0eae27dac3e3770582.gif" alt="logo" />
        <button 
          className="px-5 py-2 mt-3 md:mt-0 font-medium border border-b-4 border-r-4 border-black rounded-lg shadow-lg hover:shadow-sm"
